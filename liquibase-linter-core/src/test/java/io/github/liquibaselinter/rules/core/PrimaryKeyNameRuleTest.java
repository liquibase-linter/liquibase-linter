...
class PrimaryKeyNameRuleTest {
    ...
    class AddPrimaryKey {
        ...
        void primaryKeyNameMustFollowPatternBasic() {
            ...
            assertThat(rule.getMessage(getAddPrimaryKeyConstraintChange("INVALID_PK"))).isEqualTo("Primary key name 'INVALID_PK' is missing or does not follow pattern '^VALID_PK$'");
        ...
        void primaryKeyNameMustFollowPatternDynamicValue() {
            ...
            assertThat(rule.invalid(getAddPrimaryKeyConstraintChange("INVALID_PK"))).isTrue();
            assertThat(rule.getMessage(getAddPrimaryKeyConstraintChange("INVALID_PK"))).isEqualTo("Primary key name 'INVALID_PK' is missing or does not follow pattern '^TABLE_PK$'");
        ...
        void primaryKeyNameRuleShouldReturnFormattedErrorMessage() {
            rule.configure(RuleConfig.builder().withPattern("^VALID_PK$").withErrorMessage("Primary key constraints %s must follow pattern '%s'").build());
            assertThat(rule.getMessage(getAddPrimaryKeyConstraintChange("INVALID_PK"))).isEqualTo("Primary key constraints INVALID_PK must follow pattern '^VALID_PK$'");
        }
    ...
    class CreateTable {
        ...
        void primaryKeyNameRuleShouldReturnFormattedErrorMessage() {
            rule.configure(RuleConfig.builder().withPattern("^VALID_PK$").withErrorMessage("Primary key constraints %s must follow pattern '%s'").build());
            assertThat(rule.getMessage(createTableChange("INVALID_PK"))).isEqualTo("Primary key constraints INVALID_PK must follow pattern '^VALID_PK$'");
        }
        ...
        void compositePrimaryKeyNameShouldOnlyBeReportedOnce() {
            ...
            assertThat(rule.getMessage(createTableChange)).isEqualTo("Primary key constraints INVALID_PK must follow pattern '^VALID_PK$'");
        }
        ...
        void createTableWithMultiplePrimaryKeysShouldDetectInvalidPrimaryKey() {
            ...
            assertThat(rule.getMessage(createTableChange)).isEqualTo("Primary key name 'INVALID_PK' is missing or does not follow pattern '^VALID_PK.*$'");
        }
