...
class ChangeLogFileNameIntegrationTest extends LinterIntegrationTest {
    ...
    void registerTests() {
        shouldFail(
            ...
            "integration/changelog-file-name/file-name with-space.xml -- Message: ChangeLog filename 'integration/changelog-file-name/file-name with-space.xml' must follow pattern '^[^ ]+$'");
