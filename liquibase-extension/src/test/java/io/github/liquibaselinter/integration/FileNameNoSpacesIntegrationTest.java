...
class FileNameNoSpacesIntegrationTest extends LinterIntegrationTest {
    ...
    @LiquibaseLinterIntegrationTest(changeLogFile = "file-name-no-spaces/file-name with-space.xml", configFile = "file-name-no-spaces/file-name-no-spaces.json")
    void shouldNotAllowFileNameWithSpaces(Liquibase liquibase) {
        assertThatExceptionOfType(CommandExecutionException.class).isThrownBy(() -> liquibase.update(new Contexts(), CharStreams.nullWriter()))
            ...
            .withMessageContaining("integration/file-name-no-spaces/file-name with-space.xml -- Message: Changelog filenames should not contain spaces");
    }
    ...
    void registerTests() {
        shouldFail(
            ...
            "file-name-no-spaces/file-name with-space.xml",
            "file-name-no-spaces/file-name-no-spaces.json",
            "integration/file-name-no-spaces/file-name with-space.xml -- Message: Changelog filenames should not contain spaces");
